...
class CustomUserCreationForm(UserCreationForm):
    email = forms.EmailField(required=True, max_length=254, widget=forms.EmailInput(attrs={'class': 'input-register form-control', 'placeholder': 'Your email'}))
    ...
    marketing_consent1 = forms.BooleanField(required=False, label="I agree to receive commercial, promotional, and marketing communications.", widget=forms.CheckboxInput(attrs={'class': 'checkbox-input-register'}))
    marketing_consent2 = forms.BooleanField(required=False, label="I agree to receive personalized commercial communications.", widget=forms.CheckboxInput(attrs={'class': 'checkbox-input-register'}))
...
class CustomUserUpdateForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'company': forms.TextInput(attrs={'class': 'input-register form-control', 'placeholder': 'Your company'}),
...
class PasswordResetRequestForm(forms.Form):
    email = forms.EmailField(label="Email", max_length=254, widget=forms.EmailInput(attrs={'class': 'input-register form-control', 'placeholder': 'Your email'}))


class PasswordResetConfirmForm(forms.Form):
    new_password1 = forms.CharField(label="New Password", widget=forms.PasswordInput(attrs={'class': 'input-register form-control', 'placeholder': 'New password'}))
    new_password2 = forms.CharField(label="Confirm New Password", widget=forms.PasswordInput(attrs={'class': 'input-register form-control', 'placeholder': 'Confirm new password'}))
